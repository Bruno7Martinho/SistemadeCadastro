...
public class TelaListagemUsuarios {
    ...
    public TelaListagemUsuarios(MainActivity act, Telaprincipal telaprincipal) {
        this.act = act;
    ...
    public void CarregarTela() {
        ...
        act.setContentView(R.layout.telavisualizacao);
        ...
        btfechar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                telaprincipal.CarregarTela(); // Volta para o menu
            }
        });
    }
